...
//                    g2d.drawRect(x + 3, (256 - ((int) Interpreter.tape[Interpreter.pointer] & 0xFF)), 1, 1);
                    g2d.drawRect(Interpreter.pointer * cachedFontW + 3, (256 - ((int) Interpreter.tape[Interpreter.pointer] & 0xFF)), 1, 1);
                    g2d.drawString(Interpreter.tokens[Interpreter.ip].repr(), x, h - px / w * cachedFontH - 2);
                    Interpreter.execute();
